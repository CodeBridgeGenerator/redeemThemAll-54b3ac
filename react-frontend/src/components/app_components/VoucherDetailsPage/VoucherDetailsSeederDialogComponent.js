...
import seederData from "./voucherDetails.seeder.json";
...
const VoucherDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VoucherDetailsSeederDialogComponent);
