...
import seederData from "./userDetails.seeder.json";
...
const UserDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserDetailsSeederDialogComponent);
