const { VoucherDetails } = require("./voucherDetails.class");
const createModel = require("./voucherDetails.model");
const hooks = require("./voucherDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/voucherDetails", new VoucherDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("voucherDetails");

  // Get the schema of the collections 
  app.get("/voucherDetailsSchema", function (request, response) {
